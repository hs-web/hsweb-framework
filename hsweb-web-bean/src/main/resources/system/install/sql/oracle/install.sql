...
CREATE TABLE "S_CONFIG" (
  "U_ID" VARCHAR2(256 BYTE) NOT NULL ,
...
CREATE TABLE "S_LOGGER" (
  "U_ID" VARCHAR2(256 BYTE) NOT NULL ,
  "CLIENT_IP" VARCHAR2(256 BYTE) NULL ,
  "REQUEST_URI" VARCHAR2(1024 BYTE) NOT NULL ,
  "REQUEST_URL" VARCHAR2(2048 BYTE) NOT NULL ,
  "REQUEST_METHOD" VARCHAR2(512 BYTE) NOT NULL ,
  ...
  "REFERER" VARCHAR2(64 BYTE) NOT NULL ,
  "RESPONSE_CODE" CLOB NULL ,
  "REQUEST_HEADER" CLOB NULL ,
  "CLASS_NAME" VARCHAR2(512 BYTE) NULL ,
  "MODULE_DESC" VARCHAR2(256 BYTE) NULL ,
  "REQUEST_PARAM" CLOB NULL ,
  "EXCEPTION_INFO" CLOB NULL ,
  "CACHE_KEY" CLOB NULL ,
  "SERVER_IP" VARCHAR2(64 BYTE) NULL ,
  "APP_NAME" VARCHAR2(128 BYTE) NULL ,
...
CREATE TABLE "S_MODULES" (
  "U_ID" VARCHAR2(256 BYTE) NOT NULL ,
  "NAME" VARCHAR2(256 BYTE) NOT NULL ,
  "URI" VARCHAR2(1024 BYTE) NULL ,
  "ICON" VARCHAR2(256 BYTE) NULL ,
  "P_ID" VARCHAR2(256 BYTE) NOT NULL ,
  "REMARK" VARCHAR2(512 BYTE) NULL ,
...
CREATE TABLE "S_RESOURCES" (
  "U_ID" VARCHAR2(256 BYTE) NOT NULL ,
  "NAME" VARCHAR2(256 BYTE) NOT NULL ,
  "PATH" VARCHAR2(1024 BYTE) NOT NULL ,
  "TYPE" VARCHAR2(256 BYTE) NOT NULL ,
  "MD5" VARCHAR2(256 BYTE) NOT NULL ,
  "STATUS" NUMBER(4) NULL ,
  "CREATE_DATE" DATE NOT NULL ,
  "CREATOR_ID" VARCHAR2(256 BYTE) NOT NULL
)
;
...
CREATE TABLE "S_ROLE_MODULES" (
  "U_ID" VARCHAR2(256 BYTE) NOT NULL ,
  "MODULE_ID" VARCHAR2(256 BYTE) NOT NULL ,
  "ROLE_ID" VARCHAR2(256 BYTE) NOT NULL ,
  "O_LEVEL" CLOB NULL
)
;
...
ALTER TABLE "S_CONFIG" ADD CHECK ("CONTENT" IS NOT NULL);
ALTER TABLE "S_CONFIG" ADD CHECK ("CREATE_DATE" IS NOT NULL);
ALTER TABLE "S_CONFIG" ADD PRIMARY KEY ("U_ID");
ALTER TABLE "S_FORM" ADD CHECK ("U_ID" IS NOT NULL);
ALTER TABLE "S_FORM" ADD CHECK ("NAME" IS NOT NULL);
ALTER TABLE "S_FORM" ADD CHECK ("CREATE_DATE" IS NOT NULL);
ALTER TABLE "S_LOGGER" ADD CHECK ("REQUEST_URI" IS NOT NULL);
ALTER TABLE "S_LOGGER" ADD CHECK ("REQUEST_URL" IS NOT NULL);
ALTER TABLE "S_LOGGER" ADD CHECK ("REQUEST_METHOD" IS NOT NULL);
ALTER TABLE "S_LOGGER" ADD CHECK ("RESPONSE_CONTENT" IS NOT NULL);
ALTER TABLE "S_LOGGER" ADD CHECK ("USER_ID" IS NOT NULL);
ALTER TABLE "S_LOGGER" ADD CHECK ("REFERER" IS NOT NULL);
ALTER TABLE "S_LOGGER" ADD PRIMARY KEY ("U_ID");
ALTER TABLE "S_MODULES" ADD CHECK ("NAME" IS NOT NULL);
ALTER TABLE "S_MODULES" ADD CHECK ("P_ID" IS NOT NULL);
ALTER TABLE "S_MODULES" ADD CHECK ("M_OPTION" IS NOT NULL);
ALTER TABLE "S_MODULES" ADD CHECK ("SORT_INDEX" IS NOT NULL);
ALTER TABLE "S_MODULES" ADD PRIMARY KEY ("U_ID");
ALTER TABLE "S_RESOURCES" ADD CHECK ("NAME" IS NOT NULL);
ALTER TABLE "S_RESOURCES" ADD CHECK ("PATH" IS NOT NULL);
ALTER TABLE "S_RESOURCES" ADD CHECK ("TYPE" IS NOT NULL);
ALTER TABLE "S_RESOURCES" ADD CHECK ("MD5" IS NOT NULL);
ALTER TABLE "S_RESOURCES" ADD CHECK ("CREATE_DATE" IS NOT NULL);
ALTER TABLE "S_RESOURCES" ADD CHECK ("CREATOR_ID" IS NOT NULL);
ALTER TABLE "S_RESOURCES" ADD PRIMARY KEY ("U_ID");
ALTER TABLE "S_ROLE" ADD CHECK ("NAME" IS NOT NULL);
ALTER TABLE "S_ROLE" ADD PRIMARY KEY ("U_ID");
ALTER TABLE "S_ROLE_MODULES" ADD CHECK ("MODULE_ID" IS NOT NULL);
ALTER TABLE "S_ROLE_MODULES" ADD CHECK ("ROLE_ID" IS NOT NULL);
ALTER TABLE "S_ROLE_MODULES" ADD PRIMARY KEY ("U_ID");
ALTER TABLE "S_SCRIPT" ADD CHECK ("NAME" IS NOT NULL);
ALTER TABLE "S_SCRIPT" ADD CHECK ("PATH" IS NOT NULL);
ALTER TABLE "S_SCRIPT" ADD CHECK ("TYPE" IS NOT NULL);
ALTER TABLE "S_SCRIPT" ADD CHECK ("CONTENT" IS NOT NULL);
ALTER TABLE "S_SCRIPT" ADD PRIMARY KEY ("U_ID");
ALTER TABLE "S_TEST" ADD CHECK ("CONTENT" IS NOT NULL);
ALTER TABLE "S_TEST" ADD CHECK ("CREATE_DATE" IS NOT NULL);
ALTER TABLE "S_TEST" ADD PRIMARY KEY ("U_ID");
ALTER TABLE "S_USER" ADD CHECK ("USERNAME" IS NOT NULL);
ALTER TABLE "S_USER" ADD CHECK ("PASSWORD" IS NOT NULL);
ALTER TABLE "S_USER" ADD CHECK ("CREATE_DATE" IS NOT NULL);
ALTER TABLE "S_USER" ADD PRIMARY KEY ("U_ID");
ALTER TABLE "S_USER_ROLE" ADD CHECK ("USER_ID" IS NOT NULL);
ALTER TABLE "S_USER_ROLE" ADD CHECK ("ROLE_ID" IS NOT NULL);
